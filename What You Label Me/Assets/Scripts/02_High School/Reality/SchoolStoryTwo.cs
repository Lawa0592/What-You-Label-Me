...
/*
Introduction:
This script is responsible for managing the process of high school's story 2
*/
public class SchoolStoryTwo : MonoBehaviour
{
    ...
    private void OnTriggerStay(Collider collider)
    {
        if (collider.tag == "Player")  //checking if the collider is player's one
        {
            ...
            hintDialog.GetComponent<TMP_Text>().text = "Press space to start high school's story2";
