...
/*
Introduction:
This script is responsible for managing the process of childhood's story 3
*/
public class KidStoryThree : MonoBehaviour
{
    ...
    private void OnTriggerStay(Collider collider)
    {
        if (collider.tag == "Player")  //checking if the collider is player's one
        {
            ...
            hintDialog.GetComponent<TMP_Text>().text = "Press space to start kid's story3";
