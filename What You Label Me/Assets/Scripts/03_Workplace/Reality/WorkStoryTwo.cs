...
/*
Introduction:
This script is responsible for managing the process of workplace's story 2
*/
public class WorkStoryTwo : MonoBehaviour
{
    ...
    private void OnTriggerStay(Collider collider)
    {
        if (collider.tag == "Player")  //checking if the collider is player's one
        {
            ...
            hintDialog.GetComponent<TMP_Text>().text = "Press space to start workplace's story2";
